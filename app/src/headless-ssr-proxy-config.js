 ...
 */
const bundlePath = process.env.SITECORE_JSS_SERVER_BUNDLE || `../dist/app/server.bundle`;
...
const config = {
   ...
   */
  apiHost: process.env.SITECORE_API_HOST || 'http://sitecore',
  /**
   ...
   * Required.
   */
  apiKey: process.env.SITECORE_API_KEY || serverBundle.apiKey || '{1F33A17A-47FC-44E4-9E72-96833F787ADB}',
  /**
